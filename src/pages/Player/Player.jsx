...
const Player = () => {
  ...
  return (
    <div className='player'>
      <img src={back_arrow_icon} alt="" onClick={() => {navigate(-2)} }/> {/* Changed to navigate(-1) to go back one page */}
      <iframe 
        width='90%' 
        height='90%' 
      ...
      <div className='player-info'>
        <p>{apiData.published_at.slice(0, 10) }</p> {/* Added a check for apiData.published_at */}
        <p>{apiData.name}</p>
        <p>{apiData.type}</p>
      </div>
    </div>
